...
def build_model(config, checkpoint):
    return ProtoBasisNet(
        ...
        anchor_set_decoder=bool(config.get("anchor_set_decoder", False)),
        anchor_set_modes=int(config.get("anchor_set_modes", 20)),
        intention_trajectory_decoder=bool(config.get("intention_trajectory_decoder", False)),
